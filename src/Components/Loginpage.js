  ...
  return (
    <>
      <div className=" bg-[#346373] h-screen ">
        <div className=" flex  md:pt-10 bg-[#346373] justify-center">
          <img
            src={Image}
            alt="f"
          ...
          <div className=" md:w-[350px] lg:w-[500px] bg-white lg:rounded-r-2xl lg:p-16 p-4 pt-10  max-[400px]:">
            ...
            <div className="my-2 text-[#346373]">Forgot password?</div>
            ...
            <div className="inline-flex items-center justify-center w-full">
              ...
              <div className="md:w-40 text-center">Or log in with</div>
              <hr className="w-20 md:w-44 h-px my-8 bg-black border-0" />
            </div>
