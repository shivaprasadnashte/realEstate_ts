  ...
  return (
    <>
      <div className=" bg-[#346373] px-3 md:h-screen">
        ...
        <div className=" text-[#F04438]">Please enter the code above</div>
        <div className="flex  flex-row   w-[320px]  my-4 ">
        Didn’t receive the OTP ? <div className="text-[#346373]">Resend</div> 
            </div>
